(function() {
	...
	this.ScrollReveal = function() {
		...
		function O(e) {
			...
			var i = E(e.domEl),
				o = q(e.config.container),
				r = x(e.config.container),
		...
		return i.prototype.defaults = {
			...
			return !l && e.isSupported() && (d(t, n), e.initTimeout && window.clearTimeout(e.initTimeout), e.initTimeout = window.setTimeout(u, 0)), e
